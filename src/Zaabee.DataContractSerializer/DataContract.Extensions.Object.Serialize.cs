...
public static partial class DataContractExtensions
{
    ...
    public static void Serialize<TValue>(this TValue? value, XmlDictionaryWriter xmlDictionaryWriter) =>
        DataContractHelper.Serialize(xmlDictionaryWriter, value);

    public static void Serialize(this object? value, Type type, XmlDictionaryWriter xmlDictionaryWriter) =>
