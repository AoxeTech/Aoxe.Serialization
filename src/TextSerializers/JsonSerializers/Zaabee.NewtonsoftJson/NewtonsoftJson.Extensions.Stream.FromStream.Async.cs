...
{
    public static ValueTask<TValue?> FromStreamAsync<TValue>(this Stream? stream, JsonSerializerSettings? settings = null,
    ...
    public static ValueTask<object?> FromStreamAsync(this Stream? stream, Type type, JsonSerializerSettings? settings = null,
        Encoding? encoding = null, CancellationToken cancellationToken = default) =>
