...
{
    public static void PackTo<TValue>(this TValue? value, Stream? stream, Encoding? encoding = null) =>
    ...
    public static void PackTo(this object? value, Type type, Stream? stream, Encoding? encoding = null) =>
