...
namespace Zaabee.SystemTextJson
{
    public static class ObjectExtension
    {
        ...
        public static async Task<MemoryStream> ToStreamAsync<T>(this T t, JsonSerializerOptions options = null) =>
            await SystemTextJsonHelper.PackAsync(t, options);

        public static async Task<MemoryStream> ToStreamAsync(this object obj, Type type, JsonSerializerOptions options = null) =>
