...
public partial class Case
{
    public void ToStream(int iteration)
    {
        ...
        Console.WriteLine(
            Runner.Time(
                "DataContractHelper ToStream",
                iteration,
                () => DataContractHelper.ToStream(_testModel)
            )
        );
        Console.WriteLine(
            Runner.Time("JilHelper ToStream", iteration, () => JilHelper.ToStream(_testModel))
        );
        Console.WriteLine(
            Runner.Time(
                "MemoryPackHelper ToStream",
                iteration,
        ...
        Console.WriteLine(
            Runner.Time(
                "Utf8JsonHelper ToStream",
                iteration,
                () => Utf8JsonHelper.ToStream(_testModel)
            )
        );
        Console.WriteLine(
            Runner.Time("XmlHelper ToStream", iteration, () => XmlHelper.ToStream(_testModel))
        );
        Console.WriteLine(
            Runner.Time(
                "YamlDotNetHelper ToStream",
                iteration,
