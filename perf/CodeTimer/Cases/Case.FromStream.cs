...
public partial class Case
{
    public void FromStream(int iteration)
    {
        ...
        Console.WriteLine(
            Runner.Time(
                "NewtonsoftJsonHelper FromStream",
                iteration,
        ...
        Console.WriteLine(
            Runner.Time(
                "SystemTextJsonHelper FromStream",
                iteration,
        ...
        Console.WriteLine(
            Runner.Time(
                "ZeroFormatterHelper FromStream",
                iteration,
